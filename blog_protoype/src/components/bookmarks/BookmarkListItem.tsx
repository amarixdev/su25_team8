  ...
  return (
    <div className="bg-white rounded-lg shadow p-5">
      <div className="flex justify-between items-start">
        <div>
          <h3 className="text-lg font-medium text-indigo-600 line-clamp-1" title={bookmark.title}>{bookmark.title}</h3>
      ...
      <div className="mt-4 flex items-center justify-between">
        ...
        <button className="text-indigo-600 hover:text-indigo-800 text-sm font-medium flex-shrink-0 ml-2">
          Read
        </button>
      </div>
    </div>
